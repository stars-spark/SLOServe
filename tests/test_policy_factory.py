...
def test_build_policy_returns_slo_aware_for_slo_aware_configuration() -> None:
    policy = build_policy(_config_with_policy(SchedulerPolicyName.SLO_AWARE))

    assert isinstance(policy, SloAwarePolicy)
